public class BTreeLeafNode<TKey extends Comparable<TKey>, TValue>
  ...
  public void insertKey(TKey key, TValue value) {
    int index = 0;
    while (
      index < this.getKeyCount() && this.getKey(index).compareTo(key) < 0
    ) ++index;
  ...
  protected TKey transferFromSibling(
    ...
    this.insertKey(
        siblingNode.getKey(borrowIndex),
